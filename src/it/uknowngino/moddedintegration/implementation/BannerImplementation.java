...
public class BannerImplementation implements PopulationImplementation {
    ...
    private final File itemsFile =
            new File(ModdedIntegration.getEssentials().getDataFolder() + File.separator + getItemsFileName());
